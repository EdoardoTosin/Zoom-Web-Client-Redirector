...
- *If you want to ask anything about this project, please feel free to open an issue [here](https://github.com/EdoardoTosin/Zoom-Web-Client-Redirector/issues).*
...
### *If you would like to provide a fix for a problem you can do so by opening a Pull Request [here](https://github.com/EdoardoTosin/Zoom-Web-Client-Redirector/pulls). Below are some points to consider:*
